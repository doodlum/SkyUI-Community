class CraftingIconSetter implements skyui.components.list.IListProcessor
{
	...
	public function CraftingIconSetter(a_configAppearance)
	{
	...
	private function processEntry(a_entryObject)
	{
		switch (a_entryObject.formType)
		{
			...
			case skyui.defines.Form.TYPE_SOULGEM:
				...
				break;
			case skyui.defines.Form.TYPE_ENCHANTMENT:
	...
	// Books
	private function processBookIcon(a_entryObject)
	{
	...
	private function processSoulGemIcon(a_entryObject)
	{
	...
	private function processGrandSoulGemIcon(a_entryObject)
	{
	...
	private function processSoulGemStatusIcon(a_entryObject)
	{
		switch (a_entryObject.status)
		{
			case skyui.defines.Item.SOULGEMSTATUS_EMPTY:
	...
	private function processMiscIcon(a_entryObject)
	{
