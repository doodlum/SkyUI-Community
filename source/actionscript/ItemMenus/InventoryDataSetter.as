class InventoryDataSetter extends ItemcardDataExtender
{
  ...
  /* PRIVATE FUNCTIONS */
	...
	private function processMaterialKeywords(a_entryObject)
	{
	...
	private function processBookType(a_entryObject)
	{
	...
	private function processAmmoBaseId(a_entryObject)
	{
		switch (a_entryObject.baseId) {
	...
	private function processKeyType(a_entryObject)
	{
	...
	private function processSoulGemType(a_entryObject)
	{
		a_entryObject.subType = skyui.defines.Item.OTHER;
	...
	private function processSoulGemStatus(a_entryObject)
	{
	...
	private function processSoulGemBaseId(a_entryObject)
	{
		switch (a_entryObject.baseId) {
	...
	private function processMiscType(a_entryObject)
	{
		a_entryObject.subType = skyui.defines.Item.OTHER;
	...
	private function processMiscBaseId(a_entryObject)
	{
		switch (a_entryObject.baseId) {
