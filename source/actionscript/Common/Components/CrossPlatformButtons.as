class Components.CrossPlatformButtons extends gfx.controls.Button
{
   ...
   function RefreshArt()
   {
      ...
      var _loc3_ = this.CurrentPlatform;
      var _loc2_;
      if(_loc3_ === Shared.ButtonChange.PLATFORM_PC)
      {
      ...
      else if(_loc3_ === Shared.ButtonChange.PLATFORM_PC_GAMEPAD)
      {
         this.ButtonArt_mc = this.attachMovie(this.XBoxButton,"ButtonArt",this.getNextHighestDepth());
      }
      else if(_loc3_ === Shared.ButtonChange.PLATFORM_360)
      {
         this.ButtonArt_mc = this.attachMovie(this.XBoxButton,"ButtonArt",this.getNextHighestDepth());
      }
      else if(_loc3_ === Shared.ButtonChange.PLATFORM_PS3)
      {
