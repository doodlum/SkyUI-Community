   ...
   function EntryMatchesPartitionedFilter(aEntry)
   {
      ...
      if(aEntry != undefined)
      {
         ...
         else
         {
            ...
            _loc5_ = _loc2_ & 0xFF;
            _loc4_ = (_loc2_ & 0xFF00) >>> 8;
            _loc7_ = (_loc2_ & 0xFF0000) >>> 16;
            _loc6_ = (_loc2_ & 0xFF000000) >>> 24;
            _loc3_ = _loc5_ == this.iItemFilter || _loc4_ == this.iItemFilter || _loc7_ == this.iItemFilter || _loc6_ == this.iItemFilter;
         }
      }
      return _loc3_;
   }
