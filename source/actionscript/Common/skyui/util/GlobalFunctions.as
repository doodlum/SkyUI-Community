class skyui.util.GlobalFunctions
{
  /* PUBLIC FUNCTIONS */
    ...
    public static function extract(a_str: String, a_startChar: String, a_endChar: String)
    {
    ...
    public static function unescape(a_str: String) 
    {
        a_str = a_str.split("\\n").join("\n");
    ...
    public static function addArrayFunctions()
    {
        ...
        Array.prototype.equals = function (a: Array) 
        {
            if (a == undefined)
                return false;
    ...
    public static function mapUnicodeChar(a_charCode: Number)
    {
        //NUMERO SIGN
    ...
    public static function formatString(a_str: String /*, ... */)
    {
    ...
    public static function formatNumber(a_number: Number, a_decimal: Number)
    {
    ...
    public static function getMappedKey(a_control: String, a_context: Number, a_bGamepad: Boolean)
    {
        ...
        if (a_bGamepad == true) {
            ...
            var keyCode = skse.GetMappedKey(a_control, skyui.defines.Input.DEVICE_KEYBOARD, a_context);
            if (keyCode == -1)
    ...
    public static function hookFunction(a_scope: Object, a_memberFn: String, a_hookScope: Object, a_hookFn: String)
    {
    ...
    public static function getDistance(a: MovieClip, b: MovieClip)
    {
        var dx = b._x - a._x;
        var dy = b._y - a._y;
    ...
    public static function getAngle(a: MovieClip, b: MovieClip)
    {
        var dx = b._x - a._x;
        var dy = b._y - a._y;		
