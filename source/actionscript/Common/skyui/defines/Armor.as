...
{
   static var WEIGHT_LIGHT = 0;
   static var WEIGHT_HEAVY = 1;
   static var WEIGHT_NONE = 2;
   static var WEIGHT_CLOTHING = 3;
   static var WEIGHT_JEWELRY = 4;
   static var PARTMASK_HEAD = 1;
   static var PARTMASK_HAIR = 2;
   static var PARTMASK_BODY = 4;
   static var PARTMASK_HANDS = 8;
   static var PARTMASK_FOREARMS = 16;
   static var PARTMASK_AMULET = 32;
   static var PARTMASK_RING = 64;
   static var PARTMASK_FEET = 128;
   static var PARTMASK_CALVES = 256;
   static var PARTMASK_SHIELD = 512;
   static var PARTMASK_TAIL = 1024;
   static var PARTMASK_LONGHAIR = 2048;
   static var PARTMASK_CIRCLET = 4096;
   ...
   static var EQUIP_LONGHAIR = 2;
   static var EQUIP_BODY = 3;
   static var EQUIP_FOREARMS = 4;
   static var EQUIP_HANDS = 5;
   static var EQUIP_SHIELD = 6;
   static var EQUIP_CALVES = 7;
   static var EQUIP_FEET = 8;
   static var EQUIP_CIRCLET = 9;
   static var EQUIP_AMULET = 10;
